...
int main(void) {
  ...
  // Test of  single-ended output
	//si5351.set_freq(freq, SI5351_CLK0);		// format: (desired_freq_hz*100, OUTPUT_PIN)
	si5351.set_freq(freq, SI5351_CLK2);		// format: (desired_freq_hz*100, OUTPUT_PIN)
